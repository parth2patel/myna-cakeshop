...
>((props, ref) => {
  ...
  return (
    <div ref={ref}>
      <div className="relative w-72 underline border-b border-black">
        <button
          type="button"
          className="bg-white rounded-md w-72 pl-3 pr-10 pb-2 text-left cursor-default text-4xl font-semibold"
